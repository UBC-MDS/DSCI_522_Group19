...
```{r fig_1, echo=FALSE, fig.cap="Figure 1. Data distribution of numeric features in training datasets.", out.width = '90%'}
knitr::include_graphics("../results/repeat_plots.png")
```

```{r fig_2, echo=FALSE, fig.cap="Figure 2. Quality distribution of wines in the training and test datasets.", out.width = '90%'}
