...
After tuning the model, we will use test data set to do the final check on the accuracy. If the result is not satisfied, we will make more adjustments based on our findings. 
